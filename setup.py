#!/usr/bin/env python
"""
Simple setup script for Product Review System
Run this from the project root directory: python setup.py
"""
...
def main():
    ...
    print("Setting up Product Review System...")
    ...
    if not install_dependencies():
        print("\nFailed to install dependencies. Please try installing manually:")
...
def create_sample_data():
    """Create sample data using Django shell commands"""
